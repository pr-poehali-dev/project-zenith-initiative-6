    ...
    <header className="fixed top-0 left-0 right-0 z-40 p-4">
      <nav className="max-w-5xl mx-auto flex items-center justify-between h-12 px-6 rounded-full bg-zinc-900/70 border border-zinc-800/50 backdrop-blur-md">
        <a href="/" className="font-display text-lg font-semibold text-zinc-100 flex items-center gap-2">
          <span className="text-yellow-500">☢</span> SODA
        </a>
        <div className="hidden md:flex items-center gap-1">
          ...
          <a
            href="#shop"
            className="ml-2 px-4 py-1.5 text-sm rounded-full bg-yellow-500 text-zinc-900 font-medium hover:bg-yellow-400 transition-colors"
          >
            Магазин
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden mt-2 max-w-5xl mx-auto rounded-2xl bg-zinc-900/95 border border-zinc-800 p-4 flex flex-col gap-2">
          ...
          <a href="#shop" onClick={() => setOpen(false)} className="px-4 py-2 text-sm text-center rounded-xl bg-yellow-500 text-zinc-900 font-medium hover:bg-yellow-400 transition-colors mt-1">
            Магазин
          </a>
        </div>
      )}
