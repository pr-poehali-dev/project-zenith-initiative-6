    ...
    <section className="px-6 py-12">
      <div className="max-w-5xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="rounded-2xl border border-zinc-800/50 bg-zinc-900/50 p-6 md:p-8 flex flex-col md:flex-row items-center gap-8"
        >
          {/* Online indicator */}
          <div className="flex items-center gap-5 flex-shrink-0">
            <div className="relative">
              <div className="w-20 h-20 rounded-full border-4 border-zinc-800 flex items-center justify-center bg-zinc-950">
                <motion.div
                  className="w-12 h-12 rounded-full bg-gradient-to-br from-red-600 to-red-900"
          ...
          <a
            ...
            className="flex-shrink-0 flex items-center gap-2 px-6 py-3 rounded-full bg-red-600 hover:bg-red-500 text-white text-sm font-medium transition-all hover:scale-105 active:scale-95"
          >
