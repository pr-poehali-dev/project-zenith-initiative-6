  ...
  return (
    <section className="px-6 py-16">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="text-sm font-medium text-zinc-500 uppercase tracking-wider mb-3">{t.social.title}</p>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-zinc-500 text-xs">{tr.desc}</p>
                </div>
                <div className="relative z-10 mt-auto pt-3 border-t border-zinc-800/50">
                  ...
                  <span className="text-zinc-500 text-xs ml-2">{tr.label}</span>
                </div>
                <motion.div
